                                    ...
                                    <div class="left">
                                        <div class="mega-menu-link-wrap d-flex align-items-start justify-content-between">
                                            <div class="mega-menu-service-cards align-items-start">
                                                <div class="mega-menu-service-card">
                                                    ...
                                                    <div class="content">
                                                        <h2>
                                                            <a href="./services/ProcessAutomation.php">Process</a>
                                                        </h2>
                                                        <p>Automation</p>
                                                    </div>
                                                </div>
                                                <div class="mega-menu-service-card">
                                                    ...
                                                    <div class="content">
                                                        <h2>
                                                            <a href="./services/AIMLPage.php">AI &</a>
                                                        </h2>
                                                        <p>ML</p>
                                                    </div>
                                                </div>
                                                <div class="mega-menu-service-card">
                                                    ...
                                                    <div class="content">
                                                        <h2>
                                                            <a href="./services/DataAnalytics.php">Data</a>
                                                        </h2>
                                                        <p>Analytics</p>
                                                    </div>
                                                </div>
                                                <div class="mega-menu-service-card">
                                                    ...
                                                    <div class="content">
                                                        <h2>
                                                            <a href="./services/MarketResearch.php">Market</a>
                                                        </h2>
                                                        <p>Research</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mega-menu-links d-flex">
                                                <div class="mega-menu-link">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="./services/AIMLPage.php">Artificial Intelligence <br> Machine Learning</a>
                                                        </li>
                                                        <li>
                                                            <a href="./services/DataAnalytics.php">Data <br> Analytics</a>
                                                        </li>
                                                        <li>
                                                            <a href="./services/Cloud.php">Cloud <br>Solutions</a>
                                                        </li>
                                                        <li>
                                                            <a href="./services/MarketResearch.php">Market <br> Research</a>
                                                        </li>   
                                                    </ul>
                                                </div>
                                                <div class="mega-menu-link">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="./services/UXUI.php">User Experience & <br> User Interface</a>
                                                        </li>

                                                        <li>
                                                            <a href="./services/MobileAppDevelopment.php">Mobile App <br> Development</a>
                                                        </li>
                                                        <li>
                                        ...
                                        <div class="mega-meu-footer d-flex align-items-center justify-content-between w-full">
                                            ...
                                            <p>
                                                ...
                                                <a href="career/index.php">We're hiring</a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="right">
                                        <div class="mega-menu-ads">
                                            ...
                                            <h2>Hourspark</h2>
                                            <p>
                                            World's first 15 hours, IT task delivery service
                                            </p>
