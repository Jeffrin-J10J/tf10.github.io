      ...
      <div class="blog-details-header-content-body d-flex align-items-center">
        <div class="section-header">
          ...
          <h5 class="section-subtitle">
            Cloud Solutions, Automation and Web Application
          </h5>
  ...
  <section class="about-service3-area about-service3-style-2">
    ...
    <div class="custom-container">
      <div class="custom-row align-items-center">
        <div class="img-box">
          <img src="../assets/imgs/casestudy/cs_aim1.jpg" alt="About" />
        </div>
        ...
        <div class="content-box">
          ...
          <ul>
            <li>
              <h5>Automate Cloud Deployment</h5>
            </li>
            <li>
    ...
    <div class="custom-container">
      <div class="section-header d-flex align-items-end justify-content-between w-full">
        <div class="left">
          ...
          <h1 class="section-title">
            Automating Cloud<br />Deployment for Efficiency
          </h1>
        </div>
      ...
      <div class="our-teams-list">
        <div class="our-team-box d-flex" id="first-box">
          <div class="img-box">
            <img src="../assets/imgs/casestudy/cs1_solution1.png" alt="Team" />
          </div>
        ...
        <div class="our-team-box d-flex" id="first-box">
          <div class="img-box">
            <img src="../assets/imgs/casestudy/cs1_solution2.png" alt="Team" />
          </div>
          <div class="our-team-body card-h">
            <div class="mac-btns-wrap d-flex align-items-center justify-content-between">
              <div class="mac-buttons d-flex align-items-center">
    ...
    <div class="custom-container">
      <div class="custom-row align-items-center">
        <div class="section-header">
          ...
          <h1 class="section-title">
            Strategic Services for Optimal Performance
          </h1>
          <p>
            Optimize your business performance with our strategic and
            innovative services.
          </p>
        </div>
  ...
  <section class="portoflio-area">
    ...
    <div class="custom-container">
      ...
      <div class="service2-items d-flex w-full">
        ...
        <div class="service2-card card-h">
          <img src="../assets/imgs/industry/thumbnail/telecommunication_thumbnail.png" alt="Service" />
