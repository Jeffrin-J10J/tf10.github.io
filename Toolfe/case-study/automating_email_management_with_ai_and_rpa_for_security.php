    ...
    <div class="custom-container">
      <div class="blog-details-header-content-body d-flex align-items-center">
        <div class="section-header">
          ...
          <h5 class="section-subtitle">AI/ML, RPA</h5>
    ...
    <div class="custom-container">
      <div class="custom-row align-items-center">
        ...
        <div class="content-box">
          ...
          <ul>
            <li>
              <h5>Automate the Email Reading Process</h5>
            </li>
            <li>
              <h5>Automate Case Assignment</h5>
            </li>
            <li>
      ...
      <div class="section-header d-flex align-items-end justify-content-between w-full">
        <div class="left">
          ...
          <h1 class="section-title">
            Streamlining Operations with Advanced Technology Solutions
          </h1>
        </div>
