    ...
    <div class="custom-container">
      <div class="blog-details-header-content-body d-flex align-items-center">
        <div class="section-header">
          ...
          <h5 class="section-subtitle">AI/ML, NLP</h5>
  ...
  <section class="about-service3-area about-service3-style-2">
    ...
    <div class="custom-container">
      <div class="custom-row align-items-center">
        <div class="img-box">
          <img src="../assets/imgs/casestudy/cs5_aim.png" alt="About" />
        </div>
        ...
        <div class="content-box">
          ...
          <ul>
            ...
            <li>
              <h5>Improve Support Efficiency</h5>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="custom-container">
      <div class="section-header d-flex align-items-end justify-content-between w-full">
        <div class="left">
          ...
          <h1 class="section-title">
            Innovating Document Management with IDP and NLP Technology
          </h1>
        </div>

        <p>
          Our IDP solution uses AI and NLP to automate document processing,
      ...
      <div class="our-teams-list">
        <div class="our-team-box d-flex" id="first-box">
          <div class="img-box">
            <img src="../assets/imgs/casestudy/cs5_solution1.png" alt="Team" />
          </div>
        ...
        <div class="our-team-box d-flex" id="first-box">
          <div class="img-box">
            <img src="../assets/imgs/casestudy/cs5_solution2.png" alt="Team" />
          </div>
          <div class="our-team-body card-h">
            <div class="mac-btns-wrap d-flex align-items-center justify-content-between">
              <div class="mac-buttons d-flex align-items-center">
  ...
  <section style="margin-top: 100px;">
    <div class="custom-container">
      <div class="section-header d-flex align-items-end justify-content-between w-full">
        ...
        <p>
          Our IDP solution revolutionizes document management, automating
          processes to reduce costs, improve efficiency, and ensure precise,
          reliable information retrieval across the organization.
        </p>
      </div>
    ...
    <div class="custom-container">
      <div class="custom-row align-items-center">
        <div class="section-header">
          ...
          <p>
            Explore our range of services designed to drive your business
            forward with cutting-edge technology and expert solutions
          </p>
        </div>
