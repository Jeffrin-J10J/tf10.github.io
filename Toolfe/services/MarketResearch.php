                ...
                <div class="portfolio-lists d-flex w-full gap-24">
                    <div class="portfolio-col">
                        ...
                        <div class="portfolio-card portfolio-card-2 card-h">
                            ...
                            <div class="portfolio-img">
                                <img src="../assets/imgs/services/marketbento/2.png" alt="Portfolio"/>
                            </div>
                        </div>
                    ...
                    <div class="portfolio-col">
                        ...
                        <div class="portfolio-card portfolio-card-2 card-h">
                            <div class="portfolio-body">
                                <h2>Comprehensive Data
<br>
                                    Collection <br></a></h2>
                                <p>We use advanced techniques to achieve effective and comprehensive data collection.</p>
                               
                            </div>
                            <div class="portfolio-img">
                                <img src="../assets/imgs/services/marketbento/3.png" alt="Portfolio"/>
                            </div>
                        </div>
                        <div class="portfolio-card portfolio-card-1 card-h">
                            <div class="portfolio-img">
                    ...
                    <div class="portfolio-col">
                        ...
                        <div class="portfolio-card portfolio-card-1 card-h">
                            <div class="portfolio-img">
                                <img src="../assets/imgs/services/marketbento/5.png" alt="Portfolio"/>
                            </div>
                            <div class="portfolio-body">
                                <h2>Competitive Analysis</a></h2>
                                <p>Our team delivers in-depth competitor insights for superior market strategies.</p>
                        ...
                        <div class="portfolio-card portfolio-card-2 card-h">
                            ...
                            <div class="portfolio-img" style="height: 292px;">
                                <img src="../assets/imgs/services/marketbento/6.png"  alt="Portfolio"/>
                            </div>
                        </div>
            ...
            <div class="custom-container">
                <div class="custom-row align-items-center">
                    <div class="partner-left-content">
                        ...
                        <h1 class="section-title">Leading Technologies we're Skilled in</h1>
                        <p>Achieve market dominance with our Market Research tools,
                            effortlessly integrating insights and strategy for scalable,
                            informed decisions.</p>
                    </div>
                    <div class="right">
                        <div class="img-box">
                          <img
                            src="../assets/imgs/services/Market research.png"
                            alt="About"
                          />
                        </div>
                      </div>
        ...
        <section class="hero-section-wrap hero-home2">
            ...
            <div class="custom-container">
                ...
                <div class="hero-contact-form-wrap">
                    ...
                    <h1 class="section-title text-center">Unlock Your Market Potential</h1>   <br><br>
