                                ...
                                <div class="input-main-row">
                                    <div class="input-row">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="Company Name" id="last_name"
                                                name="last_name" />
                                        </div>
                                    </div>
                                    <div class="input-row">
                                    ...
                                    <div class="input-row">
                                        <div class="input-group">
                                            ...
                                            <div class="choice-a-company flex-wrap d-flex">
                                                ...
                                                <div class="radio-box">
                                                    <input type="radio" id="agency" name="choice_company"
                                                        value="Agency" />
                                                ...
                                                <div class="radio-box">
                                                    <input type="radio" id="other" name="choice_company"
                                                        value="Other" />
                                    ...
                                    <div class="input-row">
                                        <div class="input-group input-checkbox">
                                            <input type="checkbox" id="privacy_policy_accept"
                                                name="privacy_policy_accept" value="1">
