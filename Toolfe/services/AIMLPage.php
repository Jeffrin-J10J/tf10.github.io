        ...
        <div class="hero-section-content-wrap">
            ...
            <div class="custom-container">
                <div class="hero-section-content text-center">
                    ...
                    <h1 class="section-title fade-in">AI
                        Excellence</h1>
                ...
                <div class="section-header d-flex align-items-center justify-content-between">
                    <div class="left">
                        ...
                        <p style="max-width: 100%;">Through strategic planning and analytics, organizations extract
                            ...
                            delivering precision and relevance. Through research and strategy, we unlock growth
                ...
                <ul class="nav nav-tabs about2-tabs" role="tablist">
                    <li class="nav-item">
                        <button class="nav-link" id="business_strategy-tab" href="#business_strategy" role="tab" aria-controls="business_strategy">
                            <span class="icon">1</span> AI/ML Acceleration
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" id="market_analysis-tab" href="#market_analysis" role="tab" aria-controls="market_analysis" aria-selected="false">
                            <span class="icon">2</span> Predictive Analytics
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" id="process_optimation-tab" href="#process_optimation" role="tab" aria-controls="process_optimation" aria-selected="false">
                            <span class="icon">3</span> AI Strategy Consulting
                        </button>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <button class="nav-link" id="entrepreneurial_guidance-tab" href="#entrepreneurial_guidance" role="tab" aria-controls="entrepreneurial_guidance" aria-selected="false">
                            <span class="icon">5</span> Machine Learning Solutions
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" id="business_strategy-tab" href="#business_strategy" role="tab" aria-controls="business_strategy" aria-selected="false">
                            <span class="icon">6</span> Automated Decision Making
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" id="business_strategy-tab" href="#business_strategy" role="tab" aria-controls="business_strategy" aria-selected="false">
                            <span class="icon">7</span> Plan, Train, Implement AI/ML
                        </button>
                    </li>
                </ul>
        ...
        <div class="custom-container">
            <div class="section-header d-flex align-items-end justify-content-between">
                <div class="left">
                    ...
                    <h1 class="section-title">Why Toolfe for <br> AI/ML Services!</h1>
                </div>

                <p>At Toolfe, we provide tailored AI/ML solutions to meet your business needs. Leveraging our
                    expertise, we deliver comprehensive services to optimize operations and drive sustainable growth
                    through intelligent AI/ML operations.</p>
            </div>
            ...
            <div class="portfolio-lists d-flex w-full gap-24">
                <div class="portfolio-col">
                    ...
                    <div class="portfolio-card portfolio-card-1 card-h">
                        <div class="portfolio-img">
                            <img src="../assets/imgs/services/aibento/aibento1.png" alt="Portfolio" />
                        </div>
                        <div class="portfolio-body">
                            <h2>Boosting <br>
                                Intelligence</a></h2>
                            <p> Enhancing AI for smarter, more intelligent solutions.</p>
                ...
                <div class="portfolio-col">
                    ...
                    <div class="portfolio-card portfolio-card-2 card-h">
                        <div class="portfolio-body">
                            <h2>Leading Robotics<br>
                                Innovation <br></a></h2>
                            <p>Driving AI-Powered Robotics Innovation to Transform Industries Globally.</p>

                        </div>
                        <div class="portfolio-img">
                            <img src="../assets/imgs/services/aibento/aibento2.png" alt="Portfolio" />
                        </div>
                    </div>
                    <div class="portfolio-card portfolio-card-1 card-h">
                        <div class="portfolio-img">
                        ...
                        <div class="portfolio-body">
                            <h2>Seamless <br>
                                Integration</a></h2>
                            <p>AI integration that enhances workflow efficiency seamlessly. <br></p>
                ...
                <div class="portfolio-col">
                    ...
                    <div class="portfolio-card portfolio-card-1 card-h">
                        <div class="portfolio-img">
                            <img src="../assets/imgs/services/aibento/aibento3.png" alt="Portfolio" />
                        </div>
                        <div class="portfolio-body">
                            <h2>Scaling <br>
                                Automation</a></h2>
                            <p>Achieve Optimal Efficiency Through AI-Driven Automation Scaling.</p>
            ...
            <div class="portfolio-footer d-flex align-items-center justify-content-between w-full">
                ...
                <div class="our-expert-team-box d-flex align-items-center">
                    <div class="our-expert-team-box-inner d-flex align-items-center">
                        ...
                        <p>
                            Let's explore your AI/ML service
                            requirements
                        </p>
                    </div>
                </div>
            ...
            <div class="custom-row">
                ...
                <div class="how-we-do-left-content">
                    <div class="top">
                        ...
                        <p>We define clear AI/ML objectives to enhance accuracy and achieve operational efficiency.
                        </p>
                    </div>
                ...
                <div class="how-we-do-right-content">
                    <div class="how-we-do-items d-flex align-items-center justify-content-center">
                        ...
                        <div class="how-we-do-card">
                            ...
                            <div class="how-we-do-content">
                                <h4>Data Collection and <br> Preparation</h4>
                            </div>
                        </div>
                        ...
                        <div class="how-we-do-card">
                            ...
                            <div class="how-we-do-content">
                                <h4>Model Selection <br> and Training</h4>
                            </div>
                        </div>
                    ...
                    <div class="how-we-do-items d-flex align-items-center justify-content-center">
                        <div class="how-we-do-card">
                            ...
                            <div class="how-we-do-content">
                                <h4>Evaluation and <br> Validation</h4>
                                <p></p>
                            </div>
                        </div>
                        <div class="how-we-do-card">
                    ...
                    <div class="how-we-do-items d-flex align-items-center justify-content-center">
                        ...
                        <div class="how-we-do-card">
                            ...
                            <div class="how-we-do-content">
                                <h4>Monitoring and <br> Maintenance</h4>
                                <p></p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="custom-container">
            <div class="custom-row align-items-center">
                <div class="partner-left-content">
                    ...
                    <h1 class="section-title">Top-tier AI/ML tech we excel in</h1>
                    <p>Our expert AI/ML specialists are adept with the latest tools, dedicated to solving your
                        challenges.</p>
                </div>
                <div class="right">
                    <div class="img-box">
                        ...
                        <div id="accordion">
                            <div class="faq-box">
                                ...
                                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        AI/ML tools use smart technology to do repetitive tasks faster and with
                                        fewer mistakes, making work easier and saving time.
                                    </div>
                                </div>
                            </div>
                            <div class="faq-box">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                    <div class="card-body">
                                        We analyze data, make special computer programs, and help blend them into
                                        your work so you can make better decisions and work more efficiently.
                                    </div>
                                </div>
                            </div>
                            <div class="faq-box">
                        ...
                        <div id="accordion2">
                            <div class="faq-box">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion2">
                                    <div class="card-body">
                                        We check the data carefully, fix any mistakes, and keep an eye on it all the
                                        time to make sure it's good.
                                    </div>
                                </div>
                            </div>
                            <div class="faq-box">
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion2">
                                    <div class="card-body">
                                        They should think about how complicated their data is, how much they need to
                                        do, and if AI/ML will help them save money or do better work.
                                    </div>
                                </div>
                            </div>
                            <div class="faq-box">
            ...
            <div class="hero-contact-form-wrap">
                ...
                <div class="hero-contact-form-inner-wrap">
                    ...
                    <div class="hero-contact-form-header d-flex align-items-center justify-content-between">
                        <p>You can reach us anytime via <a href="mailto:bluebase@mail.com">support@toolfe.com</a>
                        </p>
                            ...
                            <div class="input-main-row">
                                ...
                                <div class="input-row">
                                    <div class="input-group input-checkbox">
                                        ...
                                        <label for="privacy_policy_accept">Click the box and agree to our <a href="../trust-center/terms.html" target="_blank">terms and
