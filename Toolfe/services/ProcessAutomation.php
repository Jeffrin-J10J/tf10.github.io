            ...
            <div class="custom-container">
                <div class="section-header d-flex align-items-end justify-content-between">
                    <div class="left">
                        ...
                        <h1 class="section-title">Streamline Efficiency <br>
                ...
                <div class="portfolio-lists d-flex w-full gap-24">
                    <div class="portfolio-col">
                        ...
                        <div class="portfolio-card portfolio-card-1 card-h">
                            <div class="portfolio-img">
                                <img src="../assets/imgs/services/processautomationbento/1.png" alt="Portfolio"/>
                            </div>
                    ...
                    <div class="portfolio-col">
                        ...
                        <div class="portfolio-card portfolio-card-2 card-h">
                            ...
                            <div class="portfolio-img">
                                <img src="../assets/imgs/services/processautomationbento/3.png" alt="Portfolio"/>
                            </div>
                        </div>
                        <div class="portfolio-card portfolio-card-1 card-h">
                            <div class="portfolio-img" style="height: 240px;">
                                <img src="../assets/imgs/services/processautomationbento/4.png" alt="Portfolio"/>
                            </div>
                            <div class="portfolio-body">
                                <h2>Integrated <br>
                                    Automation</a></h2>
                                <p>We integrate advanced tools to optimize your workflow seamlessly.</p>
                    ...
                    <div class="portfolio-col">
                        ...
                        <div class="portfolio-card portfolio-card-1 card-h">
                            <div class="portfolio-img">
                                <img src="../assets/imgs/services/processautomationbento/5.png" alt="Portfolio"/>
                            </div>
                            <div class="portfolio-body">
                                <h2>Automation <br>
                                   Scalability</a></h2>
                        ...
                        <div class="portfolio-card portfolio-card-2 card-h">
                            <div class="portfolio-body">
                                ...
                                <p>Automated responses for quicker customer query resolutions.</p>
                                
                            </div>
                            <div class="portfolio-img" style="height: 276px;">
                                <img src="../assets/imgs/services/processautomationbento/6.png"  alt="Portfolio"/>
                            </div>
                        </div>
                    ...
                    <div class="how-we-do-right-content">
                        <div class="how-we-do-items d-flex align-items-center justify-content-center">
                            ...
                            <div class="how-we-do-card">
                                ...
                                <div class="how-we-do-content">
                                    <h4>Map Current <br> Process Flow </h4>
                                </div>
                            </div>
                            ...
                            <div class="how-we-do-card">
                                ...
                                <div class="how-we-do-content">
                                    <h4>Define Automation <br> Goals</h4>
                                </div>
                            </div>
            ...
            <div class="custom-container">
                <div class="custom-row align-items-center">
                    ...
                    <div class="right">
                        <div class="img-box">
                          <img
                            src="../assets/imgs/services/Process automation.png"
                            alt="About"
                          />
                        </div>
                      </div>
        ...
        <section class="hero-section-wrap hero-home2">
            ...
            <div class="custom-container">
                ...
                <div class="hero-contact-form-wrap">
                    ...
                    <h1 class="section-title text-center">Automate The Impossible With Us</h1>   <br><br>
